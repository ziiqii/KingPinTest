  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (thirtyGameStatsDoc.exists()) {
        ...
        setUserStats(thirtyGameStats);
      } else {
        console.log("No such doc in ThirtyGameScreen");
      }
    } catch (error) {
    ...
    >
      <View>
        ...
        <View style={styles.chartContainer}>
          <View style={{ alignItems: "center" }}>
            <Text style={{ color: "white" }}>
              Score across the past {totalGames} games:
            </Text>
          </View>
        ...
        <View style={styles.chartContainer}>
          <View style={{ alignItems: "center" }}>
            <Text style={{ color: "white" }}>
              Strike and spare rate across the past {totalGames} games:
            </Text>
          </View>
        ...
        <View style={styles.chartContainer}>
          <View style={{ alignItems: "center" }}>
            <Text style={{ color: "white" }}>
              First shot average across the past {totalGames} games:
            </Text>
          </View>
